...
if ((1||$_COOKIE['new_diz']) && ($template === 'product/productdpo' || $template === 'product/productdpopk')) {
include(__DIR__.'/product_parser.php');
$template = 'product/product_landing';
	
	/*Переключим шаблон в случае галки*/
	foreach ($data['options'] as $option)
	{
		if ($option['option_id'] == "13" && $option['product_option_value'][0]['name'] == "Да")
		{
			$template = "product/option_product_landing";
		}
	}
}
